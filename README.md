...
- Watch the video for rest of explanation.
    <video src="https://github.com/user-attachments/assets/c1659948-2c72-4220-8a27-50387c2176a7" width="400" autoplay loop muted playsinline>Video may be temporarily unavailable. Sorry for the inconvenience.</video> <!--Playsinline is used in iOS Safari to stop playing video in fullscreen mode and allows it to run in layout-->
